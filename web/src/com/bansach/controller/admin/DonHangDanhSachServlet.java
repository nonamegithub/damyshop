...
public class DonHangDanhSachServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public DonHangDanhSachServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<DonHang> arrayDonHang = donHangBO.getTatCaDonHang();
		...
		MyUtils.forward(getServletContext(), request, response, "/admin/don-hang-danh-sach.jsp");
	}
